...
This repository records how I use [Codility's Lessons](https://app.codility.com/programmers/lessons) to develop my algorithmic thinking by consulting docs and interacting with AI. For each problem I compare alternative methods with my initial solution, refine them if needed, and present a final solution.
...
1. Initial solution — my first implementation
2. Test data — inputs and expected outputs
3. AI chat log — notes from conversations with AI
4. Improved solution — refinements
...
- `Adapted from tioback/codility-lessons — https://github.com/tioback/codility-lessons`
- `Based on work by tioback (https://github.com/tioback/codility-lessons)`
